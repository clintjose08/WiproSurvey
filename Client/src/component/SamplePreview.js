...
Welcome=()=>{
  ...
  update(quest,i){
    ...
    a[i]={"type":"question","quest":quest,"answer":e.target.value};
            ...
            <Row center="xs">
              <Paper style={{width:'100%',height:'100%'}} zDepth={1}>
                ...
                <Row center="xs">
                  ...
                  <Col xs ={5}>
                       <p style={{textAlign:'left',fontSize:'100%',fontFamily:'Doppio One',marginLeft:'2%'}}><Avatar icon= {<Person/>}
                                                                                                                   backgroundColor={'#566573'}
                                                                                                                   style={{marginTop:'2%'}} />
                                                                                                                    {this.state.output.createrName}</p>
                       <p style={{textAlign:'left',fontSize:'100%',fontFamily:'Doppio One',marginLeft:'2%'}}><Avatar icon= {<Phone/>}
                                                                                                                   backgroundColor={'#566573'}
                                                                                                                   style={{marginTop:'2%'}} />
                                                                                                                    {this.state.output.createrContact}</p>
                       <p style={{textAlign:'left',fontSize:'100%',fontFamily:'Doppio One',marginLeft:'2%'}}><Avatar icon= {<Mail/>}
                                                                                                                   backgroundColor={'#566573'}
                                                                                                                   style={{marginTop:'2%'}} />{this.state.output.createrEmail}</p>
                  </Col>
                </Row>
